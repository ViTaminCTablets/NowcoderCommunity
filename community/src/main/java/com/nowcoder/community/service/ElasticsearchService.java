...
import com.nowcoder.community.service.elasticsearch.DiscussRepository;
...
public class ElasticsearchService {
    ...
    public Page<DiscussPost> searchDiscussPost(String keyord, int current, int limit) {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.multiMatchQuery(keyord, "title", "content"))
